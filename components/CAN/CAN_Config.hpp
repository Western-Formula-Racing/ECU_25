...
#define VCU_REARPDM_COMMAND 2012
...
#define VCU_PEDALINFO 2000
#define VCU_PDMFRONT 2001
#define VCU_STATE_INFO 2002
#define VCU_PRECHARGE 2003
#define VCU_PDMREAR 2004
#define VCU_BRAKELIGHT 2011
#define VCU_REARLINPOTS 2013
...
inline CAN_Signal HSD1State_ID2001{true, 0, 1};
inline CAN_Signal HSD2State_ID2001{true, 1, 1};
inline CAN_Signal HSD3State_ID2001{true, 2, 1};
inline CAN_Signal HSD4State_ID2001{true, 3, 1};
inline CAN_Signal HSD5State_ID2001{true, 4, 1};
inline CAN_Signal HSD6State_ID2001{true, 5, 1};
inline CAN_Signal HSD7State_ID2001{true, 6, 1};
...
inline CAN_Signal BrakeLightSignal_ID2011{true, 0, 1};
...
inline CAN_Signal AverageTemp_ID6{true, 0, 16, 0.01f};
inline CAN_Signal MaxTemp_ID6{true, 16, 16, 0.01f};
inline CAN_Signal LowestCellVoltage_ID6{true, 32, 16, 0.001f};
inline CAN_Signal MaxCellDelta_ID6{true, 48, 16, 0.001f};
...
{ 
    etl::pair{VCU_REARPDM_COMMAND, etl::vector<CAN_Signal*, 32>{ 
        &HSD1_ID2012,
        &HSD2_ID2012,
        &HSD3_ID2012,
        &HSD4_ID2012,
    ...
    etl::pair{M171_FAULT_CODES, etl::vector<CAN_Signal*, 32>{ 
        &INV_Post_Fault_Lo_ID171,
        &INV_Post_Fault_Hi_ID171,
        &INV_Run_Fault_Lo_ID171,
        &INV_Run_Fault_Hi_ID171 
        } },
    etl::pair{M170_INTERNAL_STATES, etl::vector<CAN_Signal*, 32>{ 
        &INV_VSM_State_ID170,
    ...
    etl::pair{M164_DIGITAL_INPUT_STATUS, etl::vector<CAN_Signal*, 32>{ 
    ...
    etl::pair{M163_ANALOG_INPUT_VOLTAGES, etl::vector<CAN_Signal*, 32>{ 
    ...
    etl::pair{VCU_PDMFRONT, etl::vector<CAN_Signal*, 32>{ 
        &HSD1State_ID2001,
        &HSD2State_ID2001,
        &HSD3State_ID2001,
        &HSD4State_ID2001,
    ...
    etl::pair{VCU_STATE_INFO, etl::vector<CAN_Signal*, 32>{ 
        &RTD_Button_ID2002,
        &State_ID2002 
        } },
    etl::pair{VCU_PRECHARGE, etl::vector<CAN_Signal*, 32>{ 
        &Precharge_Enable_ID2003,
        &Precharge_OK_ID2003 
        } },
    etl::pair{VCU_PDMREAR, etl::vector<CAN_Signal*, 32>{ 
        &HSD1_ID2004,
        &HSD2_ID2004,
        &HSD3_ID2004,
        &HSD4_ID2004,
    ...
    etl::pair{VCU_BRAKELIGHT, etl::vector<CAN_Signal*, 32>{ 
        &BrakeLightSignal_ID2011 
        } },
    etl::pair{VCU_REARLINPOTS, etl::vector<CAN_Signal*, 32>{ 
         
        } },
    etl::pair{M177_TORQUE_CAPABILITY, etl::vector<CAN_Signal*, 32>{ 
        &INV_Torque_Capability_ID177 
        } },
    etl::pair{PACKSTATUS, etl::vector<CAN_Signal*, 32>{ 
        &PackCurrent_ID1056,
        &IMDRelay_ID1056,
        &AMSRelay_ID1056,
        &BSPDRelay_ID1056,
    ...
    etl::pair{PACKDATA, etl::vector<CAN_Signal*, 32>{ 
        &AverageTemp_ID6,
        &MaxTemp_ID6,
        &LowestCellVoltage_ID6,
        &MaxCellDelta_ID6 
        } },
    etl::pair{ELCON_LIMITS, etl::vector<CAN_Signal*, 32>{ 
        &Max_charge_voltage_ID403105268,
        &Max_charge_current_ID403105268,
        &Control_ID403105268 
        } }
};
inline etl::set CAN_Rx_IDs = {173,172,194,171,170,169,168,167,166,165,164,163,162,161,160,174,175,176,1712,1713,1714,406451072,406451073,406451074,406451075,406451076,177,1000,1006,1007,1008,1009,1010,1011,1012,1013,1014,1015,1016,1017,1018,1020,1022,1024,1026,1019,1021,1023,1025,1027,1028,1029,1030,1031,1032,1033,1034,1035,1036,1037,1038,1039,1040,1041,1042,1043,1044,1045,1046,1047,1048,1049,1050,1051,1052,1053,1054,1055,1056,6,403105268,419385573,1001,1002,1003,1004,1005,};

inline etl::set CAN_Tx_10ms_IDs = {M192_COMMAND_MESSAGE};
inline etl::set CAN_Tx_100ms_IDs = {BMS_CURRENT_LIMIT, VCU_STATE_INFO};
