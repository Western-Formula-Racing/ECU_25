...
inline etl::map CAN_Map{
    etl::pair{VCU_PDM_REAR_CMD, etl::vector<CAN_Signal *, 16>{
                                    ...
                                    &HSD7_ID2012,
                                    &HSD8_ID2012}},
    etl::pair{M173_MODULATION_AND_FLUX_INFO, etl::vector<CAN_Signal *, 16>{&INV_Modulation_Index_ID173, &INV_Flux_Weakening_Output_ID173, &INV_Id_Command_ID173, &INV_Iq_Command_ID173}}, etl::pair{M172_TORQUE_AND_TIMER_INFO, etl::vector<CAN_Signal *, 16>{&INV_Commanded_Torque_ID172, &INV_Torque_Feedback_ID172, &INV_Power_On_Timer_ID172}}, etl::pair{M194_READ_WRITE_PARAM_RESPONSE, etl::vector<CAN_Signal *, 16>{&INV_Parameter_Response_Addr_ID194, &INV_Parameter_Response_Write_OK_ID194, &INV_Parameter_Response_Data_ID194}}, etl::pair{M193_READ_WRITE_PARAM_COMMAND, etl::vector<CAN_Signal *, 16>{&VCU_INV_Parameter_Address_ID193, &VCU_INV_Parameter_RW_Command_ID193, &VCU_INV_Parameter_Data_ID193}}, etl::pair{M192_COMMAND_MESSAGE, etl::vector<CAN_Signal *, 16>{&VCU_INV_Torque_Command_ID192, &VCU_INV_Speed_Command_ID192, &VCU_INV_Direction_Command_ID192, &VCU_INV_Inverter_Enable_ID192, &VCU_INV_Inverter_Discharge_ID192, &VCU_INV_Speed_Mode_Enable_ID192, &VCU_INV_Torque_Limit_Command_ID192}}, etl::pair{M171_FAULT_CODES, etl::vector<CAN_Signal *, 16>{&INV_Post_Fault_Lo_ID171, &INV_Post_Fault_Hi_ID171, &INV_Run_Fault_Lo_ID171, &INV_Run_Fault_Hi_ID171}}, etl::pair{M170_INTERNAL_STATES, etl::vector<CAN_Signal *, 16>{&INV_VSM_State_ID170, &INV_PWM_Frequency_ID170, &INV_Inverter_State_ID170, &INV_Relay_1_Status_ID170, &INV_Relay_2_Status_ID170, &INV_Relay_3_Status_ID170, &INV_Relay_4_Status_ID170, &INV_Relay_5_Status_ID170, &INV_Relay_6_Status_ID170, &INV_Inverter_Run_Mode_ID170, &INV_Self_Sensing_Assist_Enable_ID170, &INV_Inverter_Discharge_State_ID170, &INV_Inverter_Command_Mode_ID170, &INV_Rolling_Counter_ID170, &INV_Inverter_Enable_State_ID170, &INV_Burst_Model_Mode_ID170, &INV_Key_Switch_Start_Status_ID170, &INV_Inverter_Enable_Lockout_ID170, &INV_Direction_Command_ID170, &INV_BMS_Active_ID170, &INV_BMS_Torque_Limiting_ID170, &INV_Limit_Max_Speed_ID170, &INV_Limit_Hot_Spot_ID170, &INV_Low_Speed_Limiting_ID170, &INV_Limit_Coolant_Derating_ID170, &INV_Limit_Stall_Burst_Model_ID170}}, etl::pair{M169_INTERNAL_VOLTAGES, etl::vector<CAN_Signal *, 16>{&INV_Ref_Voltage_1_5_ID169, &INV_Ref_Voltage_2_5_ID169, &INV_Ref_Voltage_5_0_ID169, &INV_Ref_Voltage_12_0_ID169}}, etl::pair{M168_FLUX_ID_IQ_INFO, etl::vector<CAN_Signal *, 16>{&INV_Vd_ff_ID168, &INV_Vq_ff_ID168, &INV_Id_ID168, &INV_Iq_ID168}}, etl::pair{M167_VOLTAGE_INFO, etl::vector<CAN_Signal *, 16>{&INV_DC_Bus_Voltage_ID167, &INV_Output_Voltage_ID167, &INV_VAB_Vd_Voltage_ID167, &INV_VBC_Vq_Voltage_ID167}}, etl::pair{M166_CURRENT_INFO, etl::vector<CAN_Signal *, 16>{&INV_Phase_A_Current_ID166, &INV_Phase_B_Current_ID166, &INV_Phase_C_Current_ID166, &INV_DC_Bus_Current_ID166}}, etl::pair{M165_MOTOR_POSITION_INFO, etl::vector<CAN_Signal *, 16>{&INV_Motor_Angle_Electrical_ID165, &INV_Motor_Speed_ID165, &INV_Electrical_Output_Frequency_ID165, &INV_Delta_Resolver_Filtered_ID165}}, etl::pair{M164_DIGITAL_INPUT_STATUS, etl::vector<CAN_Signal *, 16>{&INV_Digital_Input_1_ID164, &INV_Digital_Input_2_ID164, &INV_Digital_Input_3_ID164, &INV_Digital_Input_4_ID164, &INV_Digital_Input_5_ID164, &INV_Digital_Input_6_ID164, &INV_Digital_Input_7_ID164, &INV_Digital_Input_8_ID164}}, etl::pair{M163_ANALOG_INPUT_VOLTAGES, etl::vector<CAN_Signal *, 16>{&INV_Analog_Input_1_ID163, &INV_Analog_Input_2_ID163, &INV_Analog_Input_3_ID163, &INV_Analog_Input_4_ID163, &INV_Analog_Input_5_ID163, &INV_Analog_Input_6_ID163}}, etl::pair{M162_TEMPERATURE_SET_3, etl::vector<CAN_Signal *, 16>{&INV_Coolant_Temp_ID162, &INV_Hot_Spot_Temp_ID162, &INV_Motor_Temp_ID162, &INV_Torque_Shudder_ID162}}, etl::pair{M161_TEMPERATURE_SET_2, etl::vector<CAN_Signal *, 16>{&INV_Control_Board_Temp_ID161, &INV_RTD1_Temperature_ID161, &INV_RTD2_Temperature_ID161, &INV_Stall_Burst_Model_Temp_ID161}}, etl::pair{M160_TEMPERATURE_SET_1, etl::vector<CAN_Signal *, 16>{&INV_Module_A_Temp_ID160, &INV_Module_B_Temp_ID160, &INV_Module_C_Temp_ID160, &INV_Gate_Driver_Board_Temp_ID160}}, etl::pair{M174_FIRMWARE_INFO, etl::vector<CAN_Signal *, 16>{&INV_Project_Code_EEP_Ver_ID174, &INV_SW_Version_ID174, &INV_DateCode_MMDD_ID174, &INV_DateCode_YYYY_ID174}}, etl::pair{M175_DIAG_DATA_MESSAGE, etl::vector<CAN_Signal *, 16>{&INV_Diag_Record_ID175, &INV_Diag_Segment_ID175, &INV_Diag_Gamma_Resolver_ID175, &INV_Diag_Cos_Used_ID175, &INV_Diag_Ic_ID175, &INV_Diag_Id_cmd_ID175, &INV_Diag_Vq_Cmd_ID175, &INV_Diag_PWM_Freq_ID175, &INV_Diag_Gamma_Observer_ID175, &INV_Diag_Ia_ID175, &INV_Diag_Vdc_ID175, &INV_Diag_Mod_Index_ID175, &INV_Diag_Vd_Cmd_ID175, &INV_Diag_Run_Faults_Lo_ID175, &INV_Diag_Sin_Used_ID175, &INV_Diag_Ib_ID175, &INV_Diag_Iq_cmd_ID175, &INV_Diag_FW_Output_ID175, &INV_Diag_Vqs_Cmd_ID175, &INV_Diag_Run_Faults_Hi_ID175}}, etl::pair{BMS_CURRENT_LIMIT, etl::vector<CAN_Signal *, 16>{&BMS_Max_Discharge_Current_ID514, &BMS_Max_Charge_Current_ID514}}, etl::pair{M176_FAST_INFO, etl::vector<CAN_Signal *, 16>{&INV_Fast_Torque_Command_ID176, &INV_Fast_Torque_Feedback_ID176, &INV_Fast_Motor_Speed_ID176, &INV_Fast_DC_Bus_Voltage_ID176}}, etl::pair{VCU_PEDAL_INFO, etl::vector<CAN_Signal *, 16>{&sensorPlausibility_ID2000, &pedalPosition_ID2000, &sensor1Position_ID2000, &sensor2Position_ID2000, &brakePressure1Signal_ID2000, &brakePressure2Signal_ID2000}}, etl::pair{VCU_PDM_FRONT, etl::vector<CAN_Signal *, 16>{&HSD1_ID2001, &HSD2_ID2001, &HSD3_ID2001, &HSD4_ID2001, &HSD5_ID2001, &HSD6_ID2001, &HSD7_ID2001, &HSD8_ID2001}}, etl::pair{VCU_STATE_INFO, etl::vector<CAN_Signal *, 16>{&RTD_Button_ID2002, &State_ID2002, &Throttle_ID2002, &Brake_Percent_ID2002}}, etl::pair{VCU_PRECHARGE, etl::vector<CAN_Signal *, 16>{&Precharge_Enable_ID2003, &Precharge_OK_ID2003}}, etl::pair{VCU_PDM_REAR, etl::vector<CAN_Signal *, 16>{&HSD1_ID2004, &HSD2_ID2004, &HSD3_ID2004, &HSD4_ID2004, &HSD5_ID2004, &HSD6_ID2004, &HSD7_ID2004, &HSD8_ID2004}}, etl::pair{M177_TORQUE_CAPABILITY, etl::vector<CAN_Signal *, 16>{&INV_Torque_Capability_ID177}}, etl::pair{PACKSTATUS, etl::vector<CAN_Signal *, 16>{&PackCurrent_ID1056, &IMDRelay_ID1056, &AMSRelay_ID1056, &BSPDRelay_ID1056, &LatchRelay_ID1056, &Safetyloop_return_ID1056, &HV_Active_ID1056, &SOC_ID1056, &PackStatus_ID1056, &Fault_ID1056}}, etl::pair{ELCON_LIMITS, etl::vector<CAN_Signal *, 16>{&Max_charge_voltage_ID403105268, &Max_charge_current_ID403105268, &Control_ID403105268}}, etl::pair{VCU_FRONT_SENSORS_1, etl::vector<CAN_Signal *, 16>{&A1_ID2014, &A2_ID2014, &A3_ID2014, &A4_ID2014}}, etl::pair{VCU_FRONT_SENSORS_2, etl::vector<CAN_Signal *, 16>{&A5_ID2015, &A6_ID2015, &A7_ID2015, &A8_ID2015}}, etl::pair{VCU_FRONT_SENSORS_3, etl::vector<CAN_Signal *, 16>{&A9_ID2016, &A10_ID2016, &A11_ID2016, &A12_ID2016}}, etl::pair{VCU_FRONT_SENSORS_4, etl::vector<CAN_Signal *, 16>{&A13_ID2017, &A14_ID2017, &A15_ID2017, &A16_ID2017}}, etl::pair{VCU_REAR_SENSORS_1, etl::vector<CAN_Signal *, 16>{&A1_ID2018, &A2_ID2018, &A3_ID2018, &A4_ID2018}}, etl::pair{VCU_REAR_SENSORS_2, etl::vector<CAN_Signal *, 16>{&A5_ID2019, &A6_ID2019, &A7_ID2019, &A8_ID2019}}, etl::pair{VCU_REAR_SENSORS_3, etl::vector<CAN_Signal *, 16>{&A9_ID2020, &A10_ID2020, &A11_ID2020, &A12_ID2020}}, etl::pair{VCU_REAR_SENSORS_4, etl::vector<CAN_Signal *, 16>{&A13_ID2021, &A14_ID2021, &A15_ID2021, &A16_ID2021}}, etl::pair{BMS_MIN_VCELL, etl::vector<CAN_Signal *, 16>{&Absolute_min_cell_voltage_ID999}}, etl::pair{VCU_APPS_CALIBRATION, etl::vector<CAN_Signal *, 16>{&apps1_min_ID2022, &apps1_max_ID2022, &apps2_min_ID2022, &apps2_max_ID2022}}, etl::pair{VCU_APPS_AUTOCALIBRATE, etl::vector<CAN_Signal *, 16>{&set_min_ID2023, &set_max_ID2023}}, etl::pair{VCU_FRONT_IMU_1, etl::vector<CAN_Signal *, 16>{&Accel_X_ID2024, &Accel_Y_ID2024, &Accel_Z_ID2024}}, etl::pair{VCU_FRONT_IMU_2, etl::vector<CAN_Signal *, 16>{&Gyro_X_ID2025, &Gyro_Y_ID2025, &Gyro_Z_ID2025}}};
...
inline etl::set CAN_Tx_100ms_IDs = {VCU_FRONT_IMU_1, VCU_FRONT_IMU_2, BMS_CURRENT_LIMIT, VCU_STATE_INFO, VCU_FRONT_SENSORS_1, VCU_FRONT_SENSORS_2, VCU_FRONT_SENSORS_3, VCU_FRONT_SENSORS_4, VCU_PDM_REAR_CMD};
