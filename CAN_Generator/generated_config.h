...
{ 
    etl::pair{VCU_REARPDM_COMMAND, etl::vector<CAN_Signal*, 8>{ 
        &HSD1_ID2012,
        &HSD2_ID2012,
        &HSD3_ID2012,
        &HSD4_ID2012,
    ...
    etl::pair{M171_FAULT_CODES, etl::vector<CAN_Signal*, 8>{ 
        &INV_Post_Fault_Lo_ID171,
        &INV_Post_Fault_Hi_ID171,
        &INV_Run_Fault_Lo_ID171,
        &INV_Run_Fault_Hi_ID171 
        } },
    etl::pair{M170_INTERNAL_STATES, etl::vector<CAN_Signal*, 8>{ 
        &INV_VSM_State_ID170,
    ...
    etl::pair{M164_DIGITAL_INPUT_STATUS, etl::vector<CAN_Signal*, 8>{ 
    ...
    etl::pair{M163_ANALOG_INPUT_VOLTAGES, etl::vector<CAN_Signal*, 8>{ 
    ...
    etl::pair{VCU_PDMFRONT, etl::vector<CAN_Signal*, 8>{ 
        &HSD1State_ID2001,
        &HSD2State_ID2001,
        &HSD3State_ID2001,
        &HSD4State_ID2001,
    ...
    etl::pair{VCU_STATE_INFO, etl::vector<CAN_Signal*, 8>{ 
        &RTD_Button_ID2002,
        &State_ID2002 
        } },
    etl::pair{VCU_PRECHARGE, etl::vector<CAN_Signal*, 8>{ 
        &Precharge_Enable_ID2003,
        &Precharge_OK_ID2003 
        } },
    etl::pair{VCU_PDMREAR, etl::vector<CAN_Signal*, 8>{ 
        &HSD1_ID2004,
        &HSD2_ID2004,
        &HSD3_ID2004,
        &HSD4_ID2004,
    ...
    etl::pair{VCU_BRAKELIGHT, etl::vector<CAN_Signal*, 8>{ 
        &BrakeLightSignal_ID2011 
        } },
    etl::pair{VCU_REARLINPOTS, etl::vector<CAN_Signal*, 8>{ 
         
        } },
    etl::pair{M177_TORQUE_CAPABILITY, etl::vector<CAN_Signal*, 8>{ 
        &INV_Torque_Capability_ID177 
        } },
    etl::pair{PACKSTATUS, etl::vector<CAN_Signal*, 8>{ 
        &PackCurrent_ID1056,
        &IMDRelay_ID1056,
        &AMSRelay_ID1056,
        &BSPDRelay_ID1056,
    ...
    etl::pair{PACKDATA, etl::vector<CAN_Signal*, 8>{ 
        &AverageTemp_ID6,
        &MaxTemp_ID6,
        &LowestCellVoltage_ID6,
        &MaxCellDelta_ID6 
        } },
    etl::pair{ELCON_LIMITS, etl::vector<CAN_Signal*, 8>{ 
